...
public:
	...
	FORCEINLINE void dilate(double d) {
...
public:
	...
	FORCEINLINE bool isLeaf() { return _left == -1; }
	...
	void query(t_linearBvhNode *root, kBOX &bx, xyz2rgb &dst, xyz2rgb &minPt, double &minDist) {
		if (!_box.overlaps(bx))
			return;
...
public:
	...
	void query(kBOX &bx, xyz2rgb &dst, xyz2rgb &minPt, double &minDist)
	{
